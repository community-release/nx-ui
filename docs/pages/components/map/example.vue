			...
			<ui-map-location _showDefaultSlot="store.selectedMarker">
				<template #header>
					...
					<ui-map-location-nearest :locations="markers" icon="ic ic-location-crosshairs"
						label="Find nearest department" />
				</template>

				<template #default>
					<Transition name="slideup">
						<div v-if="store.selectedMarker" class="map-marker-info" :data="store.selectedMarker" map-layout
...
const markers = [
	...
	{
		"id": "19",
		"name": "Daugavpils filiāle (Viestura iela)",
		"address": "Viestura iela 3, Daugavpils",
		"city": "daugavpils",
		"coord": [
			26.52737,
			55.8678524
	...
	{
		"id": "20",
		"name": "Daugavpils filiāle",
		"address": "Lāčplēša iela 45, Daugavpils",
		"city": "daugavpils",
		"coord": [
			26.52485390000004,
			55.8717117
	...
	{
		"id": "21",
		"name": "Daugavpils filiāle Avene",
		"address": "Aveņu iela 26, Daugavpils",
		"city": "daugavpils",
		"coord": [
			26.5274284,
			55.9012161
